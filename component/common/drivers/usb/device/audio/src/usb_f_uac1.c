...
static inline int generic_set_cmd(struct usb_audio_control *con, uint8_t cmd, int value);
static inline int generic_get_cmd(struct usb_audio_control *con, uint8_t cmd);
